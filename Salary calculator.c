...
int main()
{
   ...
   do{
      ...
      if(rank=='a' || rank=='A'){
         if(atdn>=80){  fine=0;  } else { fine=(abs-base_ab)*.03*a_base; }
         if(cmon==4){ salary=a_base+(a_base*0.3)+a_other; } else { salary=a_base+a_other; }
         ...
         if(atdn>=80){  fine=0;  } else { fine=(abs-base_ab)*.03*b_base; }
         if(cmon==4){ salary=b_base+(b_base*0.3)+b_other; } else { salary=b_base+b_other; }
         if(hij_mon==9 || hij_mon==12){ salary=salary+b_base; } else { salary=salary+0; }
         do{
            printf("\nDisplay estimated salary for this year? Enter 'Yes' or 'No'\n=> ");
            scanf("%s", &loop3);
            if(loop3=='y'){
         ...
         if(atdn>=80){  fine=0;  } else { fine=(abs-base_ab)*.03*c_base; }
         if(cmon==4){ salary=c_base+(c_base*0.3)+c_other; } else { salary=c_base+c_other; }
         if(hij_mon==9 || hij_mon==12){ salary=salary+c_base; } else { salary=salary+0; }
         do{
            printf("\nDisplay estimated salary for this year? Enter 'Yes' or 'No'\n=> ");
            scanf("%s", &loop3);
            if(loop3=='y'){
         ...
         if(atdn>=80){  fine=0;  } else { fine=(abs-base_ab)*.03*d_base; }
         if(cmon==4){ salary=d_base+(d_base*0.3)+d_other; } else { salary=d_base+d_other; }
         if(hij_mon==9 || hij_mon==12){ salary=salary+a_base; } else { salary=salary+0; }
         do{
            printf("\nDisplay estimated salary for this year? Enter 'Yes' or 'No'\n=> ");
            scanf("%s", &loop3);
         ...
         if(atdn>=80){  fine=0;  } else { fine=(abs-base_ab)*.03*e_base; }
         if(cmon==4){ salary=e_base+(e_base*0.3)+e_other; } else { salary=e_base+e_other; }
         if(hij_mon==9 || hij_mon==12){ salary=salary+e_base; } else { salary=salary+0; }
         do{
            printf("\nDisplay estimated salary for this year? Enter 'Yes' or 'No'\n=> ");
            scanf("%s", &loop3);
            if(loop3=='y'){
